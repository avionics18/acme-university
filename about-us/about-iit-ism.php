...
<div class="page-title bg-secondary border-top border-dark py-5 mb-4">
	<div class="container">
		<h1 class="text-white font-weight-bold m-0">
			<span class="h5 text-uppercase">Home / <br></span> About IIT (ISM)
		</h1>
	</div>
</div>
			...
			<div class="col-lg-8">
				<div class="card shadow-sm">
					<div class="card-body">
						...
						<!-- Progress Bar -->
						<div>
							<div id="about-iit-ism-carousel-progress" class="custom-slick-progress" role="progressbar" aria-valuemin="0" aria-valuemax="100">
								<span class="slider__label sr-only"></span>
							</div>
						</div>
						<!-- Slider Navigation -->
						<div id="about-iit-ism-carousel-navigation" class="custom-slick-navigation text-sm-right text-center py-2">
							<div class="mb-3">
